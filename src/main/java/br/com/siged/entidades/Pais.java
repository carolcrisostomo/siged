...
@Table(name = "pais")
@NamedQueries({
    @NamedQuery(name = "Pais.findAll", query = "SELECT p FROM Pais p ORDER BY p.descricao ASC"),
...
@SequenceGenerator(name="sequence", sequenceName="seq_pais", allocationSize=1)
