...
<title><spring:message code="eixoTematico.label" /></title>
</head>
<body>


<div class="body"><% if (request.getParameter("mensagem")!=null) {%><div class="message"><%= request.getParameter("mensagem")%></div><% } %>
<spring:message code="eixoTematico.descricao.label" var="coluna1" />
<h1><spring:message code="eixoTematico.label" /></h1>


		<sec:authorize ifNotGranted="ROLE_ADMINISTRADORCONS">
			<a class="btn btn-primary btn-sm"
				href="<c:url value="/eixotematico/form"/>"> <i
...
<div class="list"><display:table uid="eixotematico"
	name="${eixostematicos}" defaultsort="1" defaultorder="ascending"
	pagesize="10" requestURI="">
	<c:url var="url" value="/eixotematico/${eixotematico.id}" />
