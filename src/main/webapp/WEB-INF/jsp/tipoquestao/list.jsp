...
<div class="body">
	...
	<% } %>
	<h1><spring:message code="tipoquestao.label" /></h1><br />
	<spring:message code="tipoquestao.descricao.label" var="coluna1" /> 
	<div class="list">
		<display:table uid="tipoquestao" name="${tiposquestoes}" defaultsort="1" defaultorder="ascending" pagesize="10" requestURI="">
			<c:url var="url" value="/tipoquestao/${tipoquestao.id}" />
			<display:column property="descricao" sortable="true" title="${coluna1}" maxLength="80" />
