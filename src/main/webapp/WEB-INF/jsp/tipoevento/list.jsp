...
<spring:message code="tipoEvento.descricao.label" var="coluna1" />
<h1><spring:message code="tipoEvento.label" /></h1>

<sec:authorize ifNotGranted="ROLE_ADMINISTRADORCONS">
			<a class="btn btn-primary btn-sm"
				href="<c:url value="/tipoevento/form"/>"> <i
...
<div class="list"><display:table uid="tipoevento"
	name="${tiposeventos}" defaultsort="1" defaultorder="ascending"
