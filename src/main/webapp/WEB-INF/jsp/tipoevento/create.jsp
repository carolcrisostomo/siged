...
<h1><spring:message code="default.add.label" /> - <spring:message
	code="tipoEvento.label" /></h1>

<c:url var="url" value="/tipoevento" /> <form:form action="${url}"
	method="POST" modelAttribute="tipoevento">
	<div class="dialog">
	<table>
		<tbody>
			<tr class="prop">
				<td valign="top" class="name"><label for="nome"><spring:message
					code="tipoEvento.descricao.label" />:</label></td>
