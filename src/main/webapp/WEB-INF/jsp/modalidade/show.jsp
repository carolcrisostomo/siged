...
<body>
	...
	<div class="body">
		...
		<h1>
			...
			-
			<spring:message code="modalidade.label" />
		</h1>
		...
		<div class="dialog">
				...
				<tbody>
					<tr class="prop">
						<td valign="top" class="name"><label for="nome"><spring:message
									code="modalidade.descricao.label" />:</label></td>
						<td valign="top" class="value">${modalidade.descricao}</td>
					</tr>
				</tbody>
			</table>
			...
			<div class="mx-auto" style="width: 400px;">
				<div class="d-flex justify-content-around p-2 ">
					...
					<a href="<c:url value="/modalidade/"/>"><button type="button"
