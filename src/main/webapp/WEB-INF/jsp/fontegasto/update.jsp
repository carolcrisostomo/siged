...
<title><spring:message code="default.button.edit.label" /> - <spring:message
	code="fonteGasto.label" /></title>
</head>
<body>

<div class="body"><% if (request.getParameter("mensagem")!=null) {%><div class="message"><%= request.getParameter("mensagem")%></div><% } %>
<h1><spring:message code="default.button.edit.label" /> - <spring:message
	code="fonteGasto.label" /></h1>
<c:url var="url" value="/fontegasto/${fontegasto.id}" /> <form:form
	action="${url}" method="PUT" modelAttribute="fontegasto">
	<div class="dialog">
	<table>
		<tbody>
			<tr class="prop">
				<td valign="top" class="name"><label for="descricao"><spring:message
					code="fonteGasto.descricao.label" /></label></td>
