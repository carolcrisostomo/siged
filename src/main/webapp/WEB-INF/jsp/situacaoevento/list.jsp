...
<spring:message code="situacaoEvento.descricao.label" var="coluna1" />
<h1><spring:message code="situacaoEvento.label" /></h1>
<br />
<div class="list"><display:table uid="situacaoevento"
	name="${situacoeseventos}" defaultsort="1" defaultorder="ascending"
