...
<body>
	<div class="body">	
		...
		<c:if test="${modalidade != null}">
			<h1>Eventos em Andamento - ${modalidade.descricao}</h1>
		</c:if>
		<c:if test="${modalidade == null}">
		...
		<c:if test="${fn:length(eventos) == 0}">
			<c:if test="${modalidade == null}">
				<div class="message">Não há eventos em andamento.</div>
			</c:if>
			<c:if test="${modalidade != null && modalidade.id == 1}">
				<div class="message">Não há eventos presenciais em andamento.</div>
			</c:if>
			<c:if test="${modalidade != null && modalidade.id == 2}">
				<div class="message">Não há eventos a distância (EAD) em andamento.</div>
			</c:if>
		</c:if>
				...
				<div class="block">
					<ul class="esq">
						...
						<%-- <c:if test="${evento.imagem != null}">
							...
							<li><img width="383" height="400" src="${urlimagem}">
							</li>
						</c:if> --%>
