...
<body>
	<div class="body">
		...
		<c:url var="url" value="/evento" />
		<form:form action="${url}" method="POST" modelAttribute="evento"
			enctype="multipart/form-data" id="createEventoForm">
			<div class="dialog">
				<table>
					<tbody>
						<tr>
						...
						<tr class="prop">
							...
							<td><form:textarea path="objetivoGeral"
									onkeyup="javascript:this.value=this.value.toUpperCase();"
									cols="70" rows="5" maxlength="1000" />* <form:errors
									path="objetivoGeral" cssClass="error" /></td>
						</tr>
						...
						<tr class="prop">
							...
							<td><form:textarea path="objetivoEspecifico"
									onkeyup="javascript:this.value=this.value.toUpperCase();"
									cols="70" rows="5" maxlength="1000" /> <form:errors
									path="objetivoEspecifico" cssClass="error" /></td>
						</tr>
						...
						<tr class="prop">
							...
							<td><form:select path="eixoTematicoId">
									<form:option value="0">Selecione...</form:option>
									<form:options items="${eixoTematicoList}" itemLabel="descricao"
										itemValue="id" />*
									</form:select>* <form:errors path="eixoTematicoId" cssClass="error" /></td>
						</tr>
						...
						<tr class="prop">
							...
							<td><form:select path="programas" items="${programaList}"
									itemLabel="descricao" itemValue="id" multiple="true" /> <form:errors
									path="programas" cssClass="error" /></td>
						</tr>
						...
						<tr class="prop">
							...
							<td><form:select path="publicoAlvoList"
									items="${tipoPublicoAlvoList2}" itemLabel="descricao"
									itemValue="id" multiple="true" />* <form:errors
						...
						<tr class="prop">
							...
							<td>
								...
								<form:errors path="modalidadeId" cssClass="error" />
							</td>
						</tr> 
						...
						<tr class="prop">
							...
							<td><form:select path="permitePreInscricao"
									class="js_permite_pre_inscricao_select" items="${SNList}" />*
								<form:errors path="permitePreInscricao" cssClass="error" /></td>
						</tr>
						...
						<tr class="prop">
							...
							<td><form:input cssStyle="width:90px" maxlength="255"
									path="dataInicioPreInscricao" size="30" alt="date"
									class="js_data_inicio_pre_inscricao" /> <form:errors
						...
						<tr class="prop">
							...
							<td><form:input cssStyle="width:90px" maxlength="255"
									path="dataFimPreInscricao" size="30" alt="date"
									class="js_data_fim_pre_inscricao" /> <form:errors
						...
						<tr class="prop">
							...
							<td><form:textarea path="conteudo"
									onkeyup="javascript:this.value=this.value.toUpperCase();"
									cols="70" rows="5" maxlength="4000" />* <form:errors
									path="conteudo" cssClass="error" /></td>
						</tr>
						...
						<tr class="prop">
							<td valign="top" class="name"><label for="observacoes"><spring:message
										code="evento.observacoes.label" />:</label></td>

							<td><form:textarea path="observacoes" cols="70" rows="5"
									maxlength="2000" /> <form:errors path="observacoes"
									cssClass="error" /></td>
						</tr>

						<tr class="prop">
							<td valign="top" class="name"><label
								for="observacoesPublicas"><spring:message
										code="evento.observacoesPublicas.label" />:</label></td>
							<td><form:textarea path="observacoesPublicas" cols="70"
									rows="5" maxlength="2000" /> <form:errors
									path="observacoesPublicas" cssClass="error" /></td>
						</tr>

						<!-- PROVEDOR ManyToMany -->
						<tr class="prop">
							<td valign="top" class="name"><label for="provedores"><spring:message
										code="evento.provedorEvento.label.plural" />:</label></td>

							<td><form:select path="provedores"
									items="${provedorEventoList}" itemLabel="descricao"
									itemValue="id" multiple="true" size="20" style="width:500px;" />*
								<form:errors path="provedores" cssClass="error" /></td>
						</tr>
						...
						<tr class="prop">
							...
							<td><form:select path="areaTribunalId">
									<form:option value="0">Selecione...</form:option>
									<form:options items="${tipoAreaTribunalList}"
										itemLabel="descricao" itemValue="id" />
								</form:select>* <form:errors path="areaTribunalId" cssClass="error" /></td>
						</tr>
						...
						<tr class="prop">
							...
							<td><form:select path="permiteCertificado" items="${NSList}" />*
						...
						<tr class="prop">
							...
							<td><form:select path="publicado" id="publicado"
									items="${SNList}" />* <form:errors path="publicado"
									cssClass="error" /></td>
						</tr>

						<!-- PUBLICADO PARA -->
						<tr class="prop" id="isRestritoContainer">
							<td valign="top" class="name"><label for="isRestrito">Publicado
									para:</label></td>
							<td><form:select path="isRestrito" id="isRestrito">
									<form:option value="0">TODOS</form:option>
									<form:option value="1">Restringir</form:option>
								</form:select>* <form:errors path="isRestrito" cssClass="error" /></td>
						</tr>

						<!-- LINK DO EVENTO -->
						<tr class="prop">
							<td valign="top" class="name"><label>Link para o
									evento:</label></td>
							<td><form:input cssStyle="width:500px" maxlength="255"
									path="linkEvento" size="30" /></td>
						</tr>

						<!-- LINK DA GRAVAO -->
						<tr class="prop">
							<td valign="top" class="name"><label>Link para a
									gravao:</label></td>
							<td><form:input cssStyle="width:500px" maxlength="255"
									path="linkGravacao" size="30" /></td>
						</tr>
						...
						<tr id="interessadosContainer">
							<td colspan="2">
								<table style="border: 0px;">
									<tr>
										<td><label>Interessados</label></td>
										<td></td>
										<td><label>Sero adicionados como interessados</label></td>
									</tr>
									<tr>
										<td style="width: 400px;"><input id="nomeParticipante"
											style="width: 370px; margin-bottom: 3px;" maxlength="255"
											name="nomeParticipante" /> <input id="buscarParticipante"
											class="search campo" type="button" /> <select
											id="naoselecionados" multiple="multiple"
											style="height: 250px; width: 380px;"></select></td>
										<td style="width: 78px;"><input id="botao1" type="button"
											title="Adicionar" value="&rsaquo;" style="width: 50px;" /><br />
										<br /> <input id="botao2" type="button" title="Remover"
											value="&lsaquo;" style="width: 50px;" /><br />
										<br /> <input id="botao3" type="button"
											title="Adicionar todos" value="&raquo;" style="width: 50px;" /><br />
										<br /> <input id="botao4" type="button" title="Remover todos"
											value="&laquo;" style="width: 50px;" /><br />
										<br /></td>
										<td style="width: 400px;"><form:select id="selecionados"
												path="interessados" items="${interessadosList}"
												itemLabel="nomeCpf" itemValue="id" multiple="multiple"
												style="height:271px; width:380px;"></form:select></td>
										<input type="hidden" id="interessadosHidden"
											name="interessadosHidden" value="" />
									</tr>
									<tr>
										<td></td>
										<td></td>
			...
			<div class="mx-auto" style="width: 400px;">
				<div class="d-flex justify-content-around p-2 ">
					...
					<button  id="criarEvento" class="btn btn-primary">
 						<spring:message code="default.add.label" />
					</button>
	...
	<script type="text/javascript">
		if ("${evento.publicoAlvoList}" != "") {
			...
			tiposSelecionados = tiposSelecionados.substr(1,
					tiposSelecionados.length - 2);
	...
	<script type="text/javascript"
		src="<c:url value="/static/js/evento.permite_pre_inscricao.js"/>"></script>
	<script type="text/javascript">
		jQuery(document)
				.ready(
						function($) {

							$('#interessadosContainer select')
									.chosen('destroy');

							updateParticipantePorNomeSelectMultiple(
									'${procuraParticipantePorNomeUrl}',
									'nomeParticipante', 'naoselecionados', '');
							...
							$("#botao1")
									.click(
											function() {
												...
												transfereSelecionados(
														'naoselecionados',
														'selecionados');
												$("#totalSeraoConfirmadas")
														.val(
																$(
																		"#selecionados")
																		.children(
							...
							$("#botao2").click(
									function() {
										...
										transfereSelecionados('selecionados',
												'naoselecionados');

										$("#totalSeraoConfirmadas").val(
												$("#selecionados").children(
														'option').length);
									});
							...
							$("#botao3").click(
									function() {
										...
										var naoselecionados = $(
												'#naoselecionados').children(
												'option').length;
										var selecionados = $('#selecionados')
												.children('option').length;

										transfereTodos('naoselecionados',
												'selecionados');
										$("#totalSeraoConfirmadas").val(
												$("#selecionados").children(
														'option').length);
							...
							$("#criarEvento")
									.click(
											function() {
												var listaSelecionados = document
														.getElementById("selecionados");
												...
												if (publicado.val() == 'S'
													...
													document
															.getElementById("interessadosHidden").value = participantesId;
