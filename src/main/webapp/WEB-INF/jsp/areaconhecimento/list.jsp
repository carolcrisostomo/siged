...
<spring:message code="areaConhecimento.descricao.label" var="coluna1" />
<h1><spring:message code="areaConhecimento.label" /></h1>


		<sec:authorize ifNotGranted="ROLE_ADMINISTRADORCONS">
			<a class="btn btn-primary btn-sm"
				href="<c:url value="/areaconhecimento/form"/>"> <i
...
<div class="list">
<display:table uid="areaconhecimento"
	name="${areasconhecimento}" defaultsort="1" defaultorder="ascending"
