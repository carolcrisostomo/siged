...
<h1>Impressão de Capas - Avaliação Reação</h1>
<c:url var="url" value="/relatorio/impressaoDeCapas/avaliacaoReacao" /> 
<form:form action="${url}" method="POST" modelAttribute="relImpressaoDeCapasAvaliacaoReacao">
	<div class="filter">
	<table>
		<tbody>
			<tr class="prop">
