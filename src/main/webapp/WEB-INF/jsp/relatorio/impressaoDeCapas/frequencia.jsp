...
<h1>Impressão de Capas - Frequência</h1>
<div></div>

<div>

</div>
<c:url var="url" value="/relatorio/impressaoDeCapas/frequencia" /> 
<form:form action="${url}" method="POST" modelAttribute="relImpressaoDeCapasFrequencia">
	<div class="filter">
	<table>
		<tbody>
			<tr class="prop">
