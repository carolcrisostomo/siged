...
<div class="avalizacaoEficaciaButton">
	...
	href="<c:url value="/relatorio/impressaoDeCapas/avaliacaoEficacia"/>" class="list">Avaliação Eficácia</a></span>	
</div>
...
<div class="frequenciaCapasButton">
<span class="menuButton"><a
	href="<c:url value="/relatorio/impressaoDeCapas/frequencia"/>" class="list">Frequência</a></span>	
</div>
<div class="body"><% if (request.getParameter("mensagem")!=null) {%><div class="message"><%= request.getParameter("mensagem")%></div><% } %>
</br>
<h1>Impressão de Capas - Indicação para Treinamento</h1>
<c:url var="url" value="/relatorio/impressaoDeCapas/indicacao" /> 
<form:form action="${url}" method="POST" modelAttribute="relImpressaoDeCapasIndicacao">
	<div class="filter">
	<table>
		<tbody>
			<tr class="prop">
