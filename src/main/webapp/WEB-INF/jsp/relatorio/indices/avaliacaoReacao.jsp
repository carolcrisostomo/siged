...
<div class="nav">
	...
	<span class="menuButton"><a
	href="<c:url value="/relatorio/indices/frequencia"/>" class="list">Frequência</a></span>
	<span class="menuButton"><a
	href="<c:url value="/relatorio/indices/indicacao"/>" class="list">Indicação para Treinamento</a></span>		
</div>
<div class="body"><% if (request.getParameter("mensagem")!=null) {%><div class="message"><%= request.getParameter("mensagem")%></div><% } %>
<h1>Impressao de Índices - Avaliação Reação</h1>
<c:url var="url" value="/relatorio/indices/avaliacaoReacao" /> 
<form:form action="${url}" method="POST" modelAttribute="relIndiceAvaliacaoReacao">
	<div class="filter">
	<table>
		<tbody>
			<tr class="prop">
