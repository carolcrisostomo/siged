...
<head>
	...
	<spring:url value="/avaliacaoreacao/procuraModulo" var="procuraModuloUrl" />
	<spring:url value="/avaliacaoreacao/procuraParticipante" var="procuraParticipanteUrl" />
	<spring:url value="/avaliacaoreacao/procuraInstrutor" var="procuraInstrutorUrl" />	
</head>

<body>
<div class="nav">
	<span class="menuButton"><a href="<c:url value="/avaliacaoreacao/minhasavaliacoes"/>" class="list">Listagem</a></span>
</div>
<div class="body">
	<c:if test="${param.mensagemAlerta != null}">
		<div class="messageAlerta">${param.mensagemAlerta}</div>
	</c:if>
	...
	<h1><spring:message code="default.add.label" /> - <spring:message code="avaliacao.label" /></h1>
	<c:url var="url" value="/avaliacaoreacao/aluno" />
	<form:form action="${url}" method="POST" modelAttribute="avaliacaoReacao">
		...
		<table>
			<tbody>
				<tr>
					<td></td>
					<td style="text-align: right;" class="name3" valign="top">(*) Campos Obrigatórios</td>
				</tr>
				...
				<tr class="prop">
					...
					<td>
						...
						<form:hidden path="participante" value="${participante.id}" />
					</td>
				</tr>
