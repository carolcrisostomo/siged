...
<spring:message code="pais.descricao.label" var="coluna1" />
<h1><spring:message code="pais.label" /></h1>



		<sec:authorize ifNotGranted="ROLE_ADMINISTRADORCONS">
			<a class="btn btn-primary btn-sm"
				href="<c:url value="/pais/form"/>"> <i
...
<div class="list"><display:table uid="pais" name="${paises}"
