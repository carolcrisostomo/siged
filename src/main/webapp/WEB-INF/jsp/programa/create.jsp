...
<h1><spring:message code="default.add.label" /> - <spring:message code="eixoTematico.label" /></h1>

<c:url var="url" value="/programa" />
<form:form action="${url}" method="POST" modelAttribute="programa">
	<div class="dialog">
	<table>
		<tbody>
			<tr class="prop">
				<td valign="top" class="name">
					<label for="nome"><spring:message code="programa.descricao.label" />:</label>
				</td>
				<td>
					<form:input cssStyle="width:400px" maxlength="255"
						path="descricao" onkeyup="javascript:this.value=this.value.toUpperCase();" size="30" />* 
