...
<spring:message code="tipoGasto.descricao.label" var="coluna1" />
<h1><spring:message code="tipoGasto.label" /></h1>

<sec:authorize ifNotGranted="ROLE_ADMINISTRADORCONS">
			<a class="btn btn-primary btn-sm"
				href="<c:url value="/tipogasto/form"/>"> <i
...
<div class="list"><display:table uid="tipogasto"
	name="${tiposgasto}" defaultsort="1" defaultorder="ascending"
