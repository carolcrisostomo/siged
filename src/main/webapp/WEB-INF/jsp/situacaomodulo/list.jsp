...
<spring:message code="situacaoModulo.descricao.label" var="coluna1" />
<h1><spring:message code="situacaoModulo.label" /></h1>
<br />
<div class="list"><display:table uid="situacaomodulo"
	name="${situacoesmodulos}" defaultsort="1" defaultorder="ascending"
