...
<body>
	...
	<div class="body">
		...
		<div class="message">Pelo menos um dos campos deve ser
			preenchido (fora a observação)</div>
		...
		<c:url var="url" value="/avaliacao/admin" />
		<form:form action="${url}" method="POST" modelAttribute="avaliacao">
			<div class="dialog">
				...
				<table>
					<tbody>
						...
						<tr class="prop">
							...
							<td>${evento} <form:hidden path="eventoId"
									value="${evento.id}" />
							</td>							
						</tr>
						<tr class="prop">
							...
							<td>${modulo} <form:hidden path="moduloId"
									value="${modulo.id}" />
							</td>
						</tr>
						...
						<tr class="prop">
							...
							<td><c:if test="${participante.nomeCpf != null}">
					${participante.nomeCpf}
					</c:if> <c:if test="${participante.nomeCpf == null}">
					NÃO IDENTIFICADO
				</c:if> <form:hidden path="participanteId" value="${participante.id}" /></td>
						</tr>
						<c:if test="${instrutor != 'DIVERSOS'}">
							...
							<tr class="prop">
								...
								<td>${instrutor} <form:hidden path="instrutorId"
										value="${instrutor.id}" />
								</td>
							</tr>
							...
							<tr class="prop">
								<td valign="top" class="name"><label
									for="questaoInstrutor1"><spring:message
							...
							<tr class="prop">
								<td valign="top" class="name"><label
									for="questaoInstrutor2"><spring:message
							...
							<tr class="prop">
								<td valign="top" class="name"><label
									for="questaoInstrutor3"><spring:message
							...
							<tr class="prop">
								<td valign="top" class="name"><label
									for="questaoInstrutor4"><spring:message
							...
							<tr class="prop">
								<td valign="top" class="name"><label
									for="questaoInstrutor5"><spring:message
							...
							<tr class="prop">
								<td valign="top" class="name"><label
									for="questaoInstrutor6"><spring:message
						...
						<c:if test="${instrutor2 != null ||Instrutor2Id}">
							...
							<tr class="prop">
								...
								<td>${instrutor2} <form:hidden path="instrutor2Id"
										value="${instrutor2.id}" />
								</td>
							</tr>
						...
						<c:if test="${instrutor3 != null ||Instrutor3Id}">
							...
							<tr class="prop">
								...
								<td>${instrutor3} <form:hidden path="instrutor3Id"
										value="${instrutor3.id}" />
								</td>
							</tr>
