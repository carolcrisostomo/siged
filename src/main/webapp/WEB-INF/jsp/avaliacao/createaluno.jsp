...
<body>
<div class="nav"><span class="menuButton"><a href="<c:url value="/avaliacao/minhasavaliacoes"/>" class="list">Listagem</a></span></div>
<div class="body"><% if (request.getParameter("mensagem")!=null) {%><div class="message"><%= request.getParameter("mensagem")%></div><% } %>
<c:if test="${mensagem!=null}">
	<div class="message"><font color="red">${mensagem}</font></div>	
</c:if>
