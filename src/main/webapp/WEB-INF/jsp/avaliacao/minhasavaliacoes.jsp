...
<display:table uid="avaliacao"
	...
	<c:url var="url" value="/avaliacao" />
	<display:column property="[1]" sortable="true"
		title="${coluna1}"
		maxLength="80" />
	<display:column property="[3]" sortable="true"
		title="${coluna2}"
		maxLength="80" />
	<!--display:column property="[5]" sortable="true"
...
<display:table uid="avaliacao2"
	name="${avaliacoes}" 
	pagesize="10" requestURI="">
	<c:url var="url" value="/avaliacao/${avaliacao2.id}" />
